...
```
fuguectl dispatch <target> --harness fugue-cc|codex|opencode [--timeout-ms n] [--codex-clean] [--harness-arg x] [--workspace ws] [--template impl --set ... | --prompt-file f | --prompt text]
```
