...
- **Planning panel** — multi-model decomposition: `"$FO" plan "<goal>" --models cc-deepseek,cc-kimi,coder` asks several models to decompose the goal (each Writes its plan); you synthesize them into Phase 1.
