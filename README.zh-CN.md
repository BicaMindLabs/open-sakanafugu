...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/assertions-388-brightgreen?style=for-the-badge" alt="388 个 fuguectl 断言" />
...
`orchestration/fuguectl/fuguectl` 是生产入口：27 个子命令、28 套测试、388 个 wrapper 断言。
...
| Memory/Evolve | `fuguectl experience add\|audit\|eval\|learn\|list\|policy\|promote\|recall\|show`、`fuguectl self-harness template\|run`、`fuguectl runtime check\|adapt`、`fuguectl selftest`                                                                                                                                              |
