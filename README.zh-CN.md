...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/assertions-400-brightgreen?style=for-the-badge" alt="400 个 fuguectl 断言" />
...
`orchestration/fuguectl/fuguectl` 是生产入口：27 个子命令、28 套测试、400 个 wrapper 断言。
