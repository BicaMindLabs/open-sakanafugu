...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/assertions-310-brightgreen?style=for-the-badge" alt="310 个 fuguectl 断言" />
...
stdout 或 durable artifact。`task log`、`summary --task` 和 `integrate --task` 也使用同样的 append-safe
审计方式记录 operator note 和 Phase 3。
