...
`workspace`, `experience`, `summary`, `doctor`, and `goal` operator scripts now
delegate to the built engine CLI at `engine/dist/cli/main.js`; set
`FUGUE_ENGINE_CLI` to override that path.
