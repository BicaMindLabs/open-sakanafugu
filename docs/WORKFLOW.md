...
Research basis: 1-2 rounds capture most reachable improvement, a hard cap prevents oscillation, and generation != review keeps the verifier independent. The memory step follows [Reflexion](https://arxiv.org/abs/2303.11366), [Self-Refine](https://arxiv.org/abs/2303.17651), [Agent Workflow Memory](https://arxiv.org/abs/2409.07429), [AgentHER](https://arxiv.org/abs/2603.21357), [MemRL](https://arxiv.org/abs/2601.03192), and recent agent-memory work: useful traces should become reusable verbal feedback, but failed traces must be explicitly relabeled before replay. FuguNano's `experience learn --allow-failure --lesson ... --failure-cause <cause>` writes that relabel with `source=task:<TASK.md>` provenance; `experience recall --failure-cause <cause> --source <manual|task> --min-score <n> --explain` filters by failure mode and source class before ranking, applies a utility gate, and prints retrieval/source evidence, reducing misaligned replay from unrelated or too-weak memories. `workspace context --experience-source <manual|task> --experience-limit <n>` and `dispatch --workspace ... --experience-source <manual|task> --experience-limit <n>` apply the same source route and explicit injection budget before automatic prompt assembly. The source filter is an operator routing and audit primitive, not a complete authority boundary. Harness evolution follows [Self-Harness](https://arxiv.org/abs/2606.09498) and related retrospective harness optimization work such as [RHO](https://arxiv.org/abs/2606.05922).
sources: [LLM Verification Loops](https://timjwilliams.medium.com/llm-verification-loops-best-practices-and-patterns-07541c854fd8) · [Loop Engineering 2026](https://shaam.blog/articles/loop-engineering-ai-agents) · [Reflexion](https://arxiv.org/abs/2303.11366) · [Self-Refine](https://arxiv.org/abs/2303.17651) · [Agent Workflow Memory](https://arxiv.org/abs/2409.07429) · [AgentHER](https://arxiv.org/abs/2603.21357) · [MemRL](https://arxiv.org/abs/2601.03192) · [How Memory Management Impacts LLM Agents](https://arxiv.org/abs/2505.16067) · [Agent-Native Memory Systems](https://arxiv.org/abs/2606.24775) · [Graph Memory for LLM Agents](https://arxiv.org/abs/2606.06036) · [Externalization in LLM Agents](https://arxiv.org/abs/2604.08224) · [Cost-Sensitive Store Routing](https://arxiv.org/abs/2603.15658) · [PROV-AGENT](https://arxiv.org/abs/2508.02866) · [LLM Agents for Interactive Workflow Provenance](https://arxiv.org/abs/2509.13978) · [Securing LLM-Agent Long-Term Memory Against Poisoning](https://arxiv.org/abs/2606.24322) · [From Untrusted Input to Trusted Memory](https://arxiv.org/abs/2606.04329) · [RecoAtlas](https://arxiv.org/abs/2605.18805) · [Self-Harness](https://arxiv.org/abs/2606.09498).

### Phase 6 — Wrap-up (fuguectl)

Review passes -> merge into the main branch, mark the TASK file `DONE`, clean up worktrees, then run `fuguectl experience learn <workspace> "<retro-title>" --task <TASK.md>` for non-obvious gotchas/decisions so the next workspace context can replay them. If a terminal failed/blocked TASK contains a reusable lesson, learn it only with `--allow-failure --lesson "<relabel>"` and add `--failure-cause <cause>` when the failure mode is clear.
