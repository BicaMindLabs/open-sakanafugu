...
Research basis: 1-2 rounds capture most reachable improvement, a hard cap prevents oscillation, and generation != review keeps the verifier independent. The memory step follows [Reflexion](https://arxiv.org/abs/2303.11366), [Self-Refine](https://arxiv.org/abs/2303.17651), [Agent Workflow Memory](https://arxiv.org/abs/2409.07429), [AgentHER](https://arxiv.org/abs/2603.21357), [MemRL](https://arxiv.org/abs/2601.03192), and recent stale/evolving/provenance/conflict-aware agent-memory work such as [STALE](https://arxiv.org/abs/2605.06527), [SSGM](https://arxiv.org/abs/2603.11768), [Agent Memory: Characterization and System Implications](https://arxiv.org/abs/2606.06448), [MemMachine](https://arxiv.org/abs/2604.04853), [MemConflict](https://arxiv.org/abs/2605.20926), [Don't Ask the LLM to Track Freshness](https://arxiv.org/abs/2606.01435), [Agent-Native Memory Systems](https://arxiv.org/abs/2606.24775), [From Agent Traces to Trust](https://arxiv.org/abs/2606.04990), [LLM Agents for Interactive Workflow Provenance](https://arxiv.org/abs/2509.13978), [Distilling Feedback into Memory-as-a-Tool](https://arxiv.org/abs/2601.05960), [Structured Belief State](https://arxiv.org/abs/2605.11325), [PROV-AGENT](https://arxiv.org/abs/2508.02866), [Securing LLM-Agent Long-Term Memory Against Poisoning](https://arxiv.org/abs/2606.24322), and [From Untrusted Input to Trusted Memory](https://arxiv.org/abs/2606.04329): useful traces should become reusable verbal feedback, but failed traces must be explicitly relabeled, stale traces must be explicitly gated, conflicting traces should be deterministically maintained, and imported traces should keep write-time origin metadata before replay. FuguNano's `experience learn --allow-failure --lesson ... --failure-cause <cause> [--supersedes <slug>]` writes that relabel with `source=task:<TASK.md>` provenance; `experience add --source-ref <ref> --trust untrusted [--supersedes <slug>]` marks imported/browser/model-derived notes with a visible origin plus write-time trust; `experience recall --failure-cause <cause> --source <manual|task> --source-ref <ref> --trust <trusted|untrusted|all> --min-score <n> --max-age-days <n> [--include-superseded] --explain` filters by failure mode, source class, exact write-time source reference, trust, explicit supersession, utility, and freshness before ranking, and prints retrieval/source/trust/freshness evidence. `workspace context --experience-source <manual|task> [--experience-source-ref <ref>] --experience-limit <n> [--experience-trust trusted|all] [--experience-max-age-days <n>]` and `dispatch --workspace ... --experience-source <manual|task> [--experience-source-ref <ref>] --experience-limit <n> [--experience-trust trusted|all] [--experience-max-age-days <n>]` apply the same source route, trusted-only default, explicit injection budget, superseded-record hiding, and optional freshness window before automatic prompt assembly, then render each injected method with parse-stable JSON `[experience:meta] {"slug":...,"sourceKind":...,"trustKind":...,"created":...}` plus source-ref/failure/supersession metadata when present. The source/source-ref/trust/supersession/freshness filters and injected metadata are operator routing and audit primitives, not complete formal authority boundaries. Harness evolution follows [Self-Harness](https://arxiv.org/abs/2606.09498) and related retrospective harness optimization work such as [RHO](https://arxiv.org/abs/2606.05922).

Machine-readable recall is the evaluation handle for that memory loop. `experience recall --json` returns the same filtered results as a stable array with method metadata, source/trust/supersession fields, body, score, matched terms, and failure-cause evidence, so operators can measure memory retrieval precision independently from generated answer quality, as pushed by [Structured Belief State](https://arxiv.org/abs/2605.11325), file-based [Memory-as-a-Tool](https://arxiv.org/abs/2601.05960), set-level utility framing in [RecoAtlas](https://arxiv.org/abs/2605.18805), and lifecycle/routing modules in [Agent-Native Memory Systems](https://arxiv.org/abs/2606.24775). When that audit must cross a trust boundary, `experience recall --json --metadata-only` replaces the raw body with `bodySha256` and `bodyChars`, preserving reproducible recall evidence while reducing the memory-membership leakage risk surfaced by [MRMMIA](https://arxiv.org/abs/2605.27825) and the provenance/evidence-tracing requirements discussed in [From Agent Traces to Trust](https://arxiv.org/abs/2606.04990) and [PROV-AGENT](https://arxiv.org/abs/2508.02866).
sources: [LLM Verification Loops](https://timjwilliams.medium.com/llm-verification-loops-best-practices-and-patterns-07541c854fd8) · [Loop Engineering 2026](https://shaam.blog/articles/loop-engineering-ai-agents) · [Reflexion](https://arxiv.org/abs/2303.11366) · [Self-Refine](https://arxiv.org/abs/2303.17651) · [Agent Workflow Memory](https://arxiv.org/abs/2409.07429) · [AgentHER](https://arxiv.org/abs/2603.21357) · [MemRL](https://arxiv.org/abs/2601.03192) · [How Memory Management Impacts LLM Agents](https://arxiv.org/abs/2505.16067) · [MemConflict](https://arxiv.org/abs/2605.20926) · [Don't Ask the LLM to Track Freshness](https://arxiv.org/abs/2606.01435) · [Agent-Native Memory Systems](https://arxiv.org/abs/2606.24775) · [Graph Memory for LLM Agents](https://arxiv.org/abs/2606.06036) · [Externalization in LLM Agents](https://arxiv.org/abs/2604.08224) · [Cost-Sensitive Store Routing](https://arxiv.org/abs/2603.15658) · [From Agent Traces to Trust](https://arxiv.org/abs/2606.04990) · [PROV-AGENT](https://arxiv.org/abs/2508.02866) · [LLM Agents for Interactive Workflow Provenance](https://arxiv.org/abs/2509.13978) · [Distilling Feedback into Memory-as-a-Tool](https://arxiv.org/abs/2601.05960) · [Structured Belief State](https://arxiv.org/abs/2605.11325) · [Securing LLM-Agent Long-Term Memory Against Poisoning](https://arxiv.org/abs/2606.24322) · [From Untrusted Input to Trusted Memory](https://arxiv.org/abs/2606.04329) / [OpenReview](https://openreview.net/forum?id=5cgg9yenCZ) · [RecoAtlas](https://arxiv.org/abs/2605.18805) · [Self-Harness](https://arxiv.org/abs/2606.09498).

### Phase 6 — Wrap-up (fuguectl)

Review passes -> merge into the main branch, mark the TASK file `DONE`, clean up worktrees, then run `fuguectl experience learn <workspace> "<retro-title>" --task <TASK.md>` for non-obvious gotchas/decisions so the next workspace context can replay them. If a terminal failed/blocked TASK contains a reusable lesson, learn it only with `--allow-failure --lesson "<relabel>"` and add `--failure-cause <cause>` when the failure mode is clear. After a model, dependency, API, or workflow change, use `--max-age-days` on manual recall or `--experience-max-age-days` on automatic injection before replaying older memories.
