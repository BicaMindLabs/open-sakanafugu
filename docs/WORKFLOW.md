...
Research basis: 1-2 rounds capture most reachable improvement, a hard cap prevents oscillation, and generation != review keeps the verifier independent. The memory step follows [Reflexion](https://arxiv.org/abs/2303.11366), [Self-Refine](https://arxiv.org/abs/2303.17651), [Agent Workflow Memory](https://arxiv.org/abs/2409.07429), [AgentHER](https://arxiv.org/abs/2603.21357), [MemRL](https://arxiv.org/abs/2601.03192), and recent stale/evolving agent-memory work such as [STALE](https://arxiv.org/abs/2605.06527), [SSGM](https://arxiv.org/abs/2603.11768), [Agent Memory: Characterization and System Implications](https://arxiv.org/abs/2606.06448), and [MemMachine](https://arxiv.org/abs/2604.04853): useful traces should become reusable verbal feedback, but failed traces must be explicitly relabeled and stale traces must be explicitly gated before replay. FuguNano's `experience learn --allow-failure --lesson ... --failure-cause <cause>` writes that relabel with `source=task:<TASK.md>` provenance; `experience add --trust untrusted` marks imported/browser/model-derived notes at write time; `experience recall --failure-cause <cause> --source <manual|task> --trust <trusted|untrusted|all> --min-score <n> --max-age-days <n> --explain` filters by failure mode, source class, trust, utility, and freshness before ranking, and prints retrieval/source/trust/freshness evidence. `workspace context --experience-source <manual|task> --experience-limit <n> [--experience-trust trusted|all] [--experience-max-age-days <n>]` and `dispatch --workspace ... --experience-source <manual|task> --experience-limit <n> [--experience-trust trusted|all] [--experience-max-age-days <n>]` apply the same source route, trusted-only default, explicit injection budget, and optional freshness window before automatic prompt assembly. The source/trust/freshness filters are operator routing and audit primitives, not complete formal authority boundaries. Harness evolution follows [Self-Harness](https://arxiv.org/abs/2606.09498) and related retrospective harness optimization work such as [RHO](https://arxiv.org/abs/2606.05922).
sources: [LLM Verification Loops](https://timjwilliams.medium.com/llm-verification-loops-best-practices-and-patterns-07541c854fd8) · [Loop Engineering 2026](https://shaam.blog/articles/loop-engineering-ai-agents) · [Reflexion](https://arxiv.org/abs/2303.11366) · [Self-Refine](https://arxiv.org/abs/2303.17651) · [Agent Workflow Memory](https://arxiv.org/abs/2409.07429) · [AgentHER](https://arxiv.org/abs/2603.21357) · [MemRL](https://arxiv.org/abs/2601.03192) · [How Memory Management Impacts LLM Agents](https://arxiv.org/abs/2505.16067) · [Agent-Native Memory Systems](https://arxiv.org/abs/2606.24775) · [Graph Memory for LLM Agents](https://arxiv.org/abs/2606.06036) · [Externalization in LLM Agents](https://arxiv.org/abs/2604.08224) · [Cost-Sensitive Store Routing](https://arxiv.org/abs/2603.15658) · [PROV-AGENT](https://arxiv.org/abs/2508.02866) · [LLM Agents for Interactive Workflow Provenance](https://arxiv.org/abs/2509.13978) · [Securing LLM-Agent Long-Term Memory Against Poisoning](https://arxiv.org/abs/2606.24322) · [From Untrusted Input to Trusted Memory](https://arxiv.org/abs/2606.04329) / [OpenReview](https://openreview.net/forum?id=5cgg9yenCZ) · [RecoAtlas](https://arxiv.org/abs/2605.18805) · [Self-Harness](https://arxiv.org/abs/2606.09498).
