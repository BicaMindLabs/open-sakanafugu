...
fuguectl incident packet /tmp/failure.log --source-ref ~/.claude/tasks/TASK-2026-06-29-023.md --json # failed trace -> cause/MAST/harness-layer evidence packet
