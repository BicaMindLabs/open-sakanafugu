...
- `fuguectl-plan` — multi-model planning panel (design panel), with `--timeout-ms` and `--harness-arg` runtime controls plus per-agent duration output for Codex/OpenCode/AGY/fugue-cc planning.
